...
public class BradlyConverter implements ImageUtil {

    static private float TRESHOLD = 0.85f;
    static private int PIECE = 20;


    private void toBlackAndWhite(BufferedImage img, int x, int y, int x1, int y1) {
    ...
    private float calculateAverageBright(BufferedImage img, int x, int y, int x1, int y1) {
    ...
    private float getPixelBright(BufferedImage img, int i, int j) {
